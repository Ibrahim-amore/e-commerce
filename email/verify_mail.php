                        ...
                        <tr><td bgcolor="#ffffff" align="center">
                                ...
                                <table  width="540" border="0" cellpadding="0" cellspacing="0" align="center" class="row" style="width:540px;max-width:540px;">
                                    ...
                                    <!-- content -->    
                                      <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
                                          ...
                                          <tr><td height="40">&nbsp;</td></tr> 
                                          <tr><td align="center" style="font-size:25px;">Email Verification</td></tr>
                            ...
                            <tr><td class="container-padding" align="center" bgcolor="#F5F5F3">
                                     <table class="row" border="0" width="480" cellpadding="0" cellspacing="0" align="center">
                                         ...
                                         <tr><td style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 14px;color: #282828;">Dear {NAME}</td></tr>
                                         ...
                                         <tr><td style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 14px;color: #282828;line-height: 22px;">
                                          ...
                                          <tr><td align="center">
                                              ...
                                              <table class="row" border="0" width="480" cellpadding="0" cellspacing="0" align="center">
                                                  <tr><td align="center">
                                                          <a href="{VERIFY-LINK}" style="color:#fff; display: inline-block; padding-top: 14px;padding-left:24px; padding-bottom:14px; padding-right:24px; text-decoration:none;cursor: pointer; background-color:#F3825D; border-radius: 5px;">Verify Your Email</a>
                                                 </td></tr>
                        ...
                        <tr><td align="center" bgcolor="#222">
                            ...
                            <tr><td class="container-padding" align="center">
                              ...
                              <tr><td align="center" style="font-family:'Josefin Sans', Arial, Helvetica, sans-serif;font-size: 18px;color: #dadada;font-weight: 400;">Get in Touch</td></tr>
                                        ...
                                        <tr><td height="20">&nbsp;</td></tr>
                                        <tr><td align="center" style="font-family:'Roboto', Arial, Helvetica, sans-serif;font-size: 13px;color: #dadada;line-height: 19px;">This email was sent to : {EMAIL}<br>
                                            You are receiving this email because you created an account with {PAGE-NAME}<br>
