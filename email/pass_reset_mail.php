                                ...
                                <table  width="540" border="0" cellpadding="0" cellspacing="0" align="center" class="row" style="width:540px;max-width:540px;">
                                    ...
                                    <!-- content -->    
                                      <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
                                          ...
                                          <tr><td height="40">&nbsp;</td></tr> 
                                          <tr><td align="center" style="font-size:20px;">Password Reset Link</td></tr>
                                     ...
                                     <table class="row" border="0" width="480" cellpadding="0" cellspacing="0" align="center">
                                         ...
                                         <tr><td style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 14px;color: #282828;line-height: 22px;">
                                          ...
                                          <tr><td align="center">
                                              ...
                                              <table class="row" border="0" width="480" cellpadding="0" cellspacing="0" align="center">
                                                  <tr><td align="center">
                                                          <a href="{RESET-LINK}" style="color:#fff; display: inline-block; padding-top: 14px;padding-left:24px; padding-bottom:14px; padding-right:24px; text-decoration:none;cursor: pointer; background-color:#222; border-radius: 5px;">Reset Password</a>
                                                 </td></tr>
